...
public class Hra implements IHra {
    ...
    public String vratUvitani() {
        return "Vítejte!\n" +
        "Toto je příběh o úniku z Čapího hnízda.\n" +
        "Hrajete za uprchlíka. Okamura vám nabídl nocleh u svého kamaráda Babiše v Čapím hnízdě.\n" + 
        "Babiš vás nutí zadarmo pracovat ve sklepě. Vám se to nelíbí a chcete uprchnout.\n" + 
        "U sebe máte pouze igelitovou tašku.\n" +
